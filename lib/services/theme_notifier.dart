...
enum AppFont {
  ...
  String get description {
    switch (this) {
      case AppFont.raleway:
        return 'Sans-serif elegante';
      case AppFont.lora:
        return 'Serif clásica';
      case AppFont.merriweather:
        return 'Diseñada para pantalla';
      case AppFont.sourceSans:
        return 'Sans-serif neutra';
      case AppFont.crimsonPro:
        return 'Serif periodística';
    }
  }
  ...
  TextTheme textTheme(TextTheme base) {
    switch (this) {
      ...
      case AppFont.crimsonPro:
        return GoogleFonts.crimsonProTextTheme(base);
    }
  }
...
class ThemeNotifier extends ChangeNotifier {
  ...
  Future<void> initialize() async {
    ...
    if (savedTypeface != null) {
      _font = AppFont.values.firstWhere((e) => e.name == savedTypeface,
          orElse: () => AppFont.raleway);
    }
  ...
  Future<void> setRefreshRate(AppRefreshRate rate) async {
    ...
    await _storage.write(
        key: _keyRefreshRate,
        value: rate == AppRefreshRate.high ? 'high' : 'standard');
    notifyListeners();
  }
